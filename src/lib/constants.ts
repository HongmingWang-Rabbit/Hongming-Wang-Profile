...
export const experiences = [
  {
    ...
    period: "2024 - Present",
    description: [
      "Built Web3 applications and DeFi platforms serving thousands of users",
      "Led frontend architecture decisions using React/Next.js with TypeScript",
      "Developed smart contract integrations and blockchain features",
      "Collaborated with cross-functional teams in fast-paced fintech environment",
    ],
